...
export default function Story() {
  return (
    <section id="story" className="px-6 py-28 lg:py-40">
      <div className="max-w-3xl mx-auto text-center">
        <motion.h2
          ...
          className="serif text-5xl md:text-6xl text-ink"
        >
        ...
        <motion.p
          ...
          className="mt-8 text-base md:text-lg leading-loose text-ink/75"
        >
        ...
        <motion.div
          ...
          className="mt-16 flex flex-wrap items-center justify-center gap-x-14 gap-y-8 serif text-ink/70"
        >
          {[
            { k: "2022", v: "Opened" },
            ...
            <div key={s.k} className="text-center">
              <div className="serif italic text-5xl text-ink">{s.k}</div>
